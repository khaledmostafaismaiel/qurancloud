...
$('#chat-text').keypress(function (event) {
  if (event.which == 13) {
    ...
    var userProfilePic = $('meta[name=user-profile_pic]').attr('content');
    $(this).val('');
    $('#chat').append("\n            <div class=\"message-section-square-from_me\">\n                <spam class=\"message-section-square-from_me-profile_pic\">\n                    <img src=\"/storage/uploads/profile_pictures/".concat(userProfilePic, "\" alt=\"User photo\" class=\"chat-side-nav__item__user-photo\">\n                </spam>\n                ").concat(body, "\n            </div>\n        "));
    var data = {
...
function getTrackInfo() {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      $('#last_track').on('click', lastTrackMethod); // //for back 5 sec

      $('#back_5_sec').on('click', back5SecMethod); //for next 5 sec

      $('#next_5_sec').on('click', next5SecMethod); //for next track

      $('#next_track').on('click', nextTrackMethod); //for duration

      $('#duration').on('change', durationMethod); //for play
...
__webpack_require__(/*! /home/khaled/programing/QuranCloud/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/khaled/programing/QuranCloud/resources/sass/app.scss */"./resources/sass/app.scss");
